...
public class Registrationlogin extends Automationdriver {
...
//  WebDriverWait wait = new WebDriverWait(driver, 10);
		...
		String name = "sreekanthambady";
		String pass = "sree@ambady009";
		...
		if (dualsim1 == false && dualsim2 == false) {
...
// row=row+1;
			...
			Boolean smssendcheck = driver.findElements(By.xpath(
...

			{
				try {
					...
					Boolean regfirstsuccess = driver.findElements(By.xpath(
...

					{
						...
						Boolean smssendwrongsim = driver.findElements(By.xpath(
								"/hierarchy/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.TextView"))
								.size() > 0;

						System.out.println("SMS from non registered SIM");
						row = row + 1;
						if (smssendwrongsim == true) {
							Excelfile.updateexcel(row, colstatus, "Pass");
			...
			/******** "Registered SIM, but SMS sending failed" **************/
				...
				Boolean smssendfail = driver.findElements(By.xpath(
						"/hierarchy/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.TextView"))
						.size() > 0;
		...
		try {
			...
			MobileElement newuserproceed = (MobileElement) driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[8]/android.widget.Button"));
			newuserproceed.click();

			Boolean newreg = driver.findElements(By.xpath(
			...
			/******
			 * MobileElement newuserback = (MobileElement) driver.findElement(By.xpath(
			 * "//android.widget.LinearLayout[@content-desc=\"Back ButtonHelps you to
			 * navigate to previous
			 * page\"]/android.widget.LinearLayout/android.widget.ImageView"));
			 * newuserback.click();
			 ******/
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		try {
			/**************
			 * Boolean dualsim110 =
			 * driver.findElements(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.ImageView")).size()
			 * > 0;
			 * 
			 * Boolean dualsim210 =
			 * driver.findElements(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout[1]/android.widget.ImageView")).size()
			 * > 0;
			 * 
			 * Boolean singlesim110 =
			 * driver.findElements(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.ImageView")).size()
			 * > 0;
			 * 
			 * if (dualsim110==true && dualsim210==true) { System.out.println("Dual SIM,
			 * improper navigation from url"); MobileElement dualsim = (MobileElement)
			 * driver.findElements(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.ImageView"));
			 * dualsim.click(); driver.manage().timeouts().implicitlyWait(10,
			 * TimeUnit.SECONDS);
			 * 
			 * MobileElement newuserproceed2= (MobileElement)
			 * driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[5]/android.widget.Button"));
			 * newuserproceed2.click();
			 * 
			 * MobileElement username123= (MobileElement)
			 * driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[5]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.EditText"));
			 * username123.click(); username123.sendKeys(name); driver.hideKeyboard();
			 * 
			 * MobileElement password123= (MobileElement)
			 * driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[7]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.EditText"));
			 * password123.click(); password123.sendKeys(pass); driver.hideKeyboard();
			 * 
			 * MobileElement register123= (MobileElement)
			 * driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[8]/android.widget.Button"));
			 * register123.click();
			 * 
			 * MobileElement acceptcheckbox= (MobileElement)
			 * driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[4]/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.ImageView"));
			 * acceptcheckbox.click();
			 * 
			 * }
			 * 
			 * else if (singlesim110==true) { System.out.println("Single SIM, improper
			 * navigation from url"); MobileElement newuserproceed2= (MobileElement)
			 * driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ViewFlipper/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[5]/android.widget.Button"));
			 * newuserproceed2.click();
			 * 
			 * MobileElement username123= (MobileElement)
		 ...
		 * Activation code is working as expected in Registarttion Screen 3"
		 **********/
